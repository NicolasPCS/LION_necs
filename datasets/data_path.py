...
def get_path(dataname=None):
    ...
    dataset_path['pointflow'] = [
        '/home/ncaytuir/data/Datasets/Mirrored_ShapeNetCore.v3.PC15k' # 30k points dataset (mirrored) 
        #'/home/ncaytuir/data-local/PVD_necs/ShapeNetCore.v6.PC15k/' # half-objects dataset 
        # #'./data/ShapeNetCore.v4.PC15k/'  # ShapeNet dataset
    ]
